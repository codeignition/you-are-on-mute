(function () {
  ...
  class Workflow {
    start() {
      ...
      const timeCheckContainer = '<div id="overlay-timecheck" class="workflow"><img src="/images/timecheck.png"><h2 id="workflow-timecheck-time"></h2></div>';
	...
	setInterval(function () {
	  ...
	  if (timeElapsed > topicTime / 2) {
	    ...
	    $("#workflow-timecheck-time").html(Math.ceil((topicTime - timeElapsed)/1000));
	  } else {
